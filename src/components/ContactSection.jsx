...
export default function ContactSection() {
  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 text-center" id="contact_me">
      {/* Fondo con gradiente sutil */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#0c0b0b] via-[#0c0a0c] to-[#0c0a0c] pointer-events-none" />
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-purple-400/10 rounded-full animate-pulse"
            style={{
        ...
        <section className="flex flex-col lg:flex-row gap-6 sm:gap-8 lg:gap-12 max-w-7xl mx-auto pt-4 sm:pt-6">
          ...
          >
            ...
            <div className="flex flex-col gap-1 items-start text-slate-300 text-sm sm:text-base">
              ...
              <textarea
                className="p-3 px-4 focus:border-gray-200/40 focus:ring-gray-200/40 outline-0 flex-1 w-full border opacity-80 rounded-md min-h-28 sm:min-h-32 bg-slate-800 border-slate-700 shadow-sm text-slate-300 resize-none transition-all"
          ...
          <section className="flex-1 flex flex-col w-full">
            ...
            <section className="mt-6 sm:mt-8">
              ...
              <div className="flex gap-5 sm:gap-6 items-center justify-start">
                ...
                >
                  <FaGithub 
                    className="text-3xl sm:text-4xl text-purple-400 hover:text-purple-500 hover:scale-105 transition-all ease-in-out duration-300 cursor-pointer"
                    style={{ filter: 'drop-shadow(0px 0px 4px rgba(128, 0, 128, 0.4))' }} 
                  />
                </a>

...
/>
            ...
            <article className="lg:flex-initial flex justify-center items-center lg:items-start flex-col">
                <h1 className='text-7xl text-white font-extrabold tracking-tight pb-2'>
                    {t("hero_section.greet")} 
                </h1>
                <span className="bg-gradient-to-r from-rose-400 via-purple-500 to-purple-700 inline-block text-transparent bg-clip-text text-7xl font-extrabold">Jesús</span>
                <p className='text-purple-300 text-xl py-3 purple-glow'>
                    {t('full_stack_developer')}
                </p>

                <p className='text-gray-50 max-w-xl text-lg'>
                    <span>
                        {t('hero_section.subtitle')}
                    </span>
                </p>

                <section className='flex gap-6 pb-6 pt-6'>
                    <Metrics 
                        number={3}
                        label={t('hero_section.years_experience')}
                    />
                    <Metrics 
                        number={10}
                        label={t('hero_section.completed_projects')}
                    />
                    {/* <Metrics 
                        number={3}
                        label={t('hero_section.years_experience')}
                ...
                <div className='flex gap-5 mt-6'>
                    ...
                    <a href={i18n?.language == "es" ? cv : encv} download="CV_JesusM.pdf"  title={t('download_resume')}>
                        <IoMdDownload className="text-4xl text-purple-400 hover:text-purple-600 hover:scale-110 

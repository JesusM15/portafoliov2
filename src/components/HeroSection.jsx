...
import cv from "./../assets/CV_JesusM_espanol.pdf";
import encv from "./../assets/CV_JesusM_en.pdf";
  ...
  return (
    ...
    >
      ...
      <article className="relative z-10 flex flex-col items-center lg:justify-center lg:items-start w-full lg:max-w-[720px]">
        ...
        <section className="flex flex-wrap gap-4 sm:gap-6 pb-4 sm:pb-6 pt-6 justify-center lg:justify-start w-full">
          <Metrics number={5} label={t("hero_section.years_experience")} />
          <Metrics number={10} label={t("hero_section.completed_projects")} />
          <Metrics number={2} label={t("hero_section.oss_libraries")} plus={false} />
        </section>
